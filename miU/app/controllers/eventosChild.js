        ...
        //
            ...
            var xhr = Ti.Network.createHTTPClient({
                ...
                onload: function(e) {
                    ...
                    var detail = Alloy.createController("eventosChildDetail",{name : json.name, date: json.date, persons: json.persons, 
                                                        image : json.image, duration : json.duration, description : json.description, categories : json.categories});
                    detail.open();
