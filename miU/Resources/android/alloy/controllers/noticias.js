...
function Controller() {
    ...
    __alloyId11.push($.__views._Row_noticias);
    ...
    $.__views.__alloyId12 = Ti.UI.createSearchBar(function() {
        var o = {};
        _.extend(o, {
            width: "auto",
            barColor: "#164A94",
    ...
    __alloyId13.push($.__views._Row_categorias);
    ...
    $.__views.__alloyId14 = Ti.UI.createSearchBar(function() {
        var o = {};
        _.extend(o, {
            width: "auto",
            barColor: "#164A94",
    ...
    var xhr = Ti.Network.createHTTPClient({
        ...
        onload: function() {
            ...
            readable = true;
            for (i = 0; i < json.length; i++) noticiasChild.push(Alloy.createModel("noticias", {
                id: json[i].id,
                name: json[i].name,
                image: json[i].image,
                date: json[i].date
