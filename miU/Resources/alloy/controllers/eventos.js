function Controller() {
    ...
    var __alloyId4 = [];
    __alloyId4.push($.__views._Row_eventos);
    ...
    $.__views.__alloyId5 = Ti.UI.createSearchBar(function() {
        var o = {};
        _.extend(o, {
            width: "auto",
            barColor: "#164A94",
    ...
    var __alloyId6 = [];
    __alloyId6.push($.__views._Row_categorias);
    ...
    var offsetAPI = 0;
    var limitAPI = 30;
    var baseUrl = "http://miuniversidad-site.dev01.icti.es/api/eventos/lista/";
    var xhr = Ti.Network.createHTTPClient({
        ...
        onload: function() {
            ...
            readable = true;
            for (i = 0; json.length > i; i++) eventosChild.push(Alloy.createModel("eventos", {
                id: json[i].id,
                name: json[i].name,
                image: json[i].image,
                date: json[i].date
            ...
            for (var i = 0; eventosChild.length > i; i++) {
    ...
    var baseUrl = "http://miuniversidad-site.dev01.icti.es/api/eventos_categorias/lista/";
    var xhr = Ti.Network.createHTTPClient({
        cache: true,
        onload: function() {
            readyToScroll = false;
